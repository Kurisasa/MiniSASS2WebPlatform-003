...
public class CloudMessagingRegistrar {
    ...
    public static ResponseDTO sendRegistration(String regID,
        ...
        Message message = new Message.Builder().addData(
                "message",
                "MiniSASS Mobile device registered to send and receive messages. Completed on "
    ...
    //Simple API Access in the console
    ...
    private static final String API_KEY = "AIzaSyBQap7FTpd14vmg8lua78NtlbvsEJ9eJiI";
}
